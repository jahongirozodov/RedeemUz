        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cars_Attachments_AttachmentId",
                        column: x => x.AttachmentId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NumberOfPassenger = table.Column<short>(type: "smallint", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    DriveId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AttachmentId", "CreatedAt", "Firstname", "Gender", "IsDeleted", "Lastname", "Password", "Phone", "Role", "UpdatedAt", "Username" },
                values: new object[] { 1L, null, new DateTime(2023, 10, 3, 14, 1, 41, 157, DateTimeKind.Utc).AddTicks(6328), "Test", 0, false, "Testov", "$2a$11$4WSvAdHs2pSABPzDEQT/6Os8/K/ylycyHIjQlv8jiXFNpT4X3d/Le", "+998881234567", 1, null, "Testbek" });

            migrationBuilder.CreateIndex(
                name: "IX_Cars_AttachmentId",
                table: "Cars",
                column: "AttachmentId");
