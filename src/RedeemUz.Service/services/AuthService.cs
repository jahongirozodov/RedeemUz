...
public class AuthService : IAuthService
{
    ...
    public async ValueTask<string> GenerateTokenForUserAsync(string phone, string originalPassword)
    {
    ...
    public async ValueTask<string> GenerateTokenForManagerAsync(string phone, string originalPassword)
    {
        var user = await this.unitOfWork.UserRepository.SelectAsync(u => u.Phone.Equals(phone));
        if (user is null)
            throw new NotFoundException("This Manager is not found");
